...
const VERIFIED_GENUINE_JOBS: GenuineFresherJob[] = [
  // ==================== ZOHO CORPORATION ====================
  {
    ...
    livePortalUrl: 'https://www.linkedin.com/company/zoho/jobs/',
    is2026Eligible: true,
    activelyHiring: true,
  ...
  // ==================== TATA CONSULTANCY SERVICES (TCS) ====================
  {
    ...
    livePortalUrl: 'https://www.linkedin.com/company/tata-consultancy-services/jobs/',
    is2026Eligible: true,
    activelyHiring: true,
  ...
  // ==================== INFOSYS ====================
  {
    ...
    livePortalUrl: 'https://www.linkedin.com/company/infosys/jobs/',
    is2026Eligible: true,
    activelyHiring: true,
  ...
  // ==================== WIPRO ====================
  {
    ...
    livePortalUrl: 'https://www.linkedin.com/company/wipro/jobs/',
    is2026Eligible: true,
    activelyHiring: true,
    verifiedOnPortals: ['LinkedIn', 'Naukri', 'Official Careers'],
  ...
  // ==================== ACCENTURE ====================
  {
    ...
    livePortalUrl: 'https://www.linkedin.com/company/accenture/jobs/',
    is2026Eligible: true,
    activelyHiring: true,
    verifiedOnPortals: ['LinkedIn', 'Naukri', 'Official Careers'],
  ...
  // ==================== CAPGEMINI ====================
  {
    ...
    livePortalUrl: 'https://www.linkedin.com/company/capgemini/jobs/',
    is2026Eligible: true,
    activelyHiring: true,
    verifiedOnPortals: ['LinkedIn', 'Naukri', 'Shine', 'Official Careers'],
  ...
  // ==================== JUSPAY ====================
  {
    ...
    livePortalUrl: 'https://www.linkedin.com/company/juspay/jobs/',
    is2026Eligible: true,
    activelyHiring: true,
    verifiedOnPortals: ['LinkedIn', 'Official Careers'],
  ...
  // ==================== COGNIZANT ====================
  {
    ...
    livePortalUrl: 'https://www.linkedin.com/company/cognizant/jobs/',
    is2026Eligible: true,
    activelyHiring: true,
    verifiedOnPortals: ['LinkedIn', 'Naukri', 'Official Careers'],
  ...
  // ==================== VIRTUSA ====================
  {
    ...
    livePortalUrl: 'https://www.linkedin.com/company/virtusa/jobs/',
    is2026Eligible: true,
    activelyHiring: true,
  ...
  // ==================== HCLTECH ====================
  {
    ...
    livePortalUrl: 'https://www.linkedin.com/company/hcltech/jobs/',
    is2026Eligible: true,
    activelyHiring: true,
  ...
  // ==================== PERSISTENT SYSTEMS ====================
  {
    ...
    livePortalUrl: 'https://www.linkedin.com/company/persistent-systems/jobs/',
    is2026Eligible: true,
    activelyHiring: true,
    verifiedOnPortals: ['LinkedIn', 'Naukri', 'Official Careers'],
  ...
  // ==================== LTIMINDTREE ====================
  {
    ...
    livePortalUrl: 'https://www.linkedin.com/company/ltimindtree/jobs/',
    is2026Eligible: true,
    activelyHiring: true,
    verifiedOnPortals: ['LinkedIn', 'Naukri', 'Official Careers'],
          ...
          >
            ...
            <div className="pt-4 border-t border-[#1f2430] flex flex-col sm:flex-row items-center justify-between gap-3">
              ...
              <div className="flex flex-wrap items-center gap-2 w-full sm:w-auto">
                ...
                >
                  <span>{selectedJobForModal.source} Jobs</span>
                  <ExternalLink className="w-3 h-3" />
                </button>
              </div>
            </div>
